...
int main()
{
    ...
    Aquila::WindowType window = Aquila::WIN_RECT;   // Aquila::WIN_RECT, Aquila::WIN_HAMMING, Aquila::WIN_HANN are available
	...
	boost::shared_ptr<MECclassifier> myClassifier(new MECclassifier(sampleSize, 
                                                                    sampleFreq, 
                                                                    numChannels, 
                                                                    usePadding,
                                                                    window));    
